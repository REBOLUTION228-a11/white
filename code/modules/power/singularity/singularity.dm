...
/obj/singularity/attack_tk(mob/user)
	...
	if(jedi.stat == DEAD)
		...
		qdel(rip_u)
		return
	addtimer(CALLBACK(GLOBAL_PROC, GLOBAL_PROC_REF(carbon_tk_part_two), jedi), 0.1 SECONDS)
...
/obj/singularity/proc/carbon_tk_part_two(mob/living/carbon/jedi)
	...
	if(jedi.stat == DEAD)
		...
		if(rip_u)
			...
			qdel(rip_u)
		return
	addtimer(CALLBACK(GLOBAL_PROC, GLOBAL_PROC_REF(carbon_tk_part_three), jedi), 0.1 SECONDS)
