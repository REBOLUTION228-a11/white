...
/obj/structure/railing/Initialize()
	...
	AddComponent(/datum/component/simple_rotation,ROTATION_ALTCLICK | ROTATION_CLOCKWISE | ROTATION_COUNTERCLOCKWISE | ROTATION_VERBS ,null,CALLBACK(src, .procTYPE_PROC_REF(/can_be_rotated),CALLBACK(src,, after_rotation)))
